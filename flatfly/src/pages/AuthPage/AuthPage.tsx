    ...
    return (
        <div
            className={`w-full flex flex-col items-center interFont text-black dark:text-white bg-transparent ${
                isLogin
                    ? "min-h-screen px-4 pb-10 pt-[112px] sm:px-6 min-[771px]:pt-[108px] min-[771px]:sm:pt-[116px]"
                    : "min-h-screen flex flex-col pb-10 pt-[112px] max-[770px]:pb-8 min-[771px]:pt-[108px] min-[771px]:sm:pt-[116px]"
            }`}
        >
            <div
