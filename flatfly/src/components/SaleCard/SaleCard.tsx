...
export default function SaleCard({
    ...
    const cardShell = cg
        ? normalizedType === "NEIGHBOUR"
            ...
            : "h-[283px] w-[256px] max-w-full shrink-0 rounded-lg shadow-sm max-[770px]:mx-auto max-[770px]:h-auto max-[770px]:min-h-0 max-[770px]:w-[min(100%,22rem)] max-[770px]:max-w-[22rem] min-[771px]:w-full min-[771px]:min-w-0 min-[771px]:h-[299px] min-[1024px]:h-[311px] min-[1280px]:h-[323px]"
