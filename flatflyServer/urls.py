...
urlpatterns = [
    ...
    path("api/auth/email/resend-verification/", views.resend_verification_email, name="resend_verification_email"),
    path("api/auth/email-confirm/<str:token>/", views.confirm_email, name="confirm_email"),
